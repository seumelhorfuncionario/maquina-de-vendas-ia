...
export const mockLeads: Lead[] = [
  { id: 'l1', name: 'Ana Paula Silva', phone: '(11) 98765-4321', product: 'Quadro Canvas Premium', origin: 'Instagram Ads', status: 'Novo Lead', createdAt: '2026-04-05', value: 189.90 },
  { id: 'l2', name: 'Roberto Almeida', phone: '(11) 91234-5678', product: 'Kit 3 Quadros Decorativos', origin: 'Google Ads', status: 'Novo Lead', createdAt: '2026-04-05', value: 259.90 },
  { id: 'l3', name: 'Fernanda Costa', phone: '(21) 99876-5432', product: 'Quadro Acrílico Premium', origin: 'Facebook Ads', status: 'Qualificando', createdAt: '2026-04-04', value: 349.90 },
  { id: 'l4', name: 'Marcelo Santos', phone: '(11) 97654-3210', product: 'Quadro Canvas Grande', origin: 'Instagram Ads', status: 'Qualificando', createdAt: '2026-04-04', value: 289.90 },
  { id: 'l5', name: 'Juliana Mendes', phone: '(31) 98765-1234', product: 'Quadro Personalizado', origin: 'Google Ads', status: 'Orçamento Enviado', createdAt: '2026-04-03', value: 399.90 },
  { id: 'l6', name: 'Pedro Oliveira', phone: '(11) 96543-2109', product: 'Quadro Canvas Premium', origin: 'Instagram Ads', status: 'Orçamento Enviado', createdAt: '2026-04-03', value: 189.90 },
  { id: 'l7', name: 'Camila Rocha', phone: '(21) 95432-1098', product: 'Kit 3 Quadros Decorativos', origin: 'Facebook Ads', status: 'Orçamento Enviado', createdAt: '2026-04-02', value: 259.90 },
  { id: 'l8', name: 'Lucas Ferreira', phone: '(11) 94321-0987', product: 'Quadro Canvas Grande', origin: 'Google Ads', status: 'Venda Fechada', createdAt: '2026-04-01', value: 289.90 },
  { id: 'l9', name: 'Maria Clara Souza', phone: '(31) 93210-9876', product: 'Quadro Acrílico Premium', origin: 'Instagram Ads', status: 'Venda Fechada', createdAt: '2026-04-01', value: 349.90 },
  { id: 'l10', name: 'Thiago Barbosa', phone: '(11) 92109-8765', product: 'Quadro MDF Slim', origin: 'Google Ads', status: 'Venda Fechada', createdAt: '2026-03-31', value: 119.90 },
  { id: 'l11', name: 'Beatriz Lima', phone: '(21) 91098-7654', product: 'Quadro Canvas Premium', origin: 'Facebook Ads', status: 'Venda Fechada', createdAt: '2026-03-30', value: 189.90 },
  { id: 'l12', name: 'Gabriel Nunes', phone: '(11) 90987-6543', product: 'Kit 3 Quadros Decorativos', origin: 'Instagram Ads', status: 'Venda Fechada', createdAt: '2026-03-29', value: 259.90 },
  { id: 'l13', name: 'Renata Dias', phone: '(31) 99876-5431', product: 'Quadro Canvas Grande', origin: 'Google Ads', status: 'Venda Fechada', createdAt: '2026-03-28', value: 289.90 },
  { id: 'l14', name: 'Diego Martins', phone: '(11) 98765-4320', product: 'Placa de ACM', origin: 'Google Ads', status: 'Venda Fechada', createdAt: '2026-03-27', value: 450.00 },
  { id: 'l15', name: 'Patrícia Gomes', phone: '(21) 97654-3219', product: 'Adesivo Parede', origin: 'Instagram Ads', status: 'Venda Fechada', createdAt: '2026-03-26', value: 320.00 },
  { id: 'l16', name: 'Rafael Cardoso', phone: '(11) 96543-2108', product: 'Quadro Canvas Premium', origin: 'Facebook Ads', status: 'Perdido', createdAt: '2026-04-03', value: 189.90 },
  { id: 'l17', name: 'Isabela Pereira', phone: '(31) 95432-1097', product: 'Quadro MDF Slim', origin: 'Instagram Ads', status: 'Perdido', createdAt: '2026-04-02', value: 119.90 },
  { id: 'l18', name: 'Vinícius Araújo', phone: '(11) 94321-0986', product: 'Quadro Canvas Grande', origin: 'Google Ads', status: 'Novo Lead', createdAt: '2026-04-05', value: 289.90 },
  { id: 'l19', name: 'Carolina Machado', phone: '(21) 93210-9875', product: 'Quadro Personalizado', origin: 'Facebook Ads', status: 'Qualificando', createdAt: '2026-04-04', value: 399.90 },
  { id: 'l20', name: 'André Teixeira', phone: '(11) 92109-8764', product: 'Quadro Acrílico Premium', origin: 'Instagram Ads', status: 'Novo Lead', createdAt: '2026-04-05', value: 349.90 },
]
